...
const swaggerUiOptions = {
    ...
    definition: {
        openapi: '3.0.3',
        info: {
            title: 'Kalyxi Flow APIs',
            summary: 'Interactive swagger-ui auto-generated API docs from express, based on a swagger.yml file',
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from Kalyxi Flow express backend, based on a swagger.yml file. Swagger is available on: http://localhost:6655/api-docs',
            license: {
                name: 'Apache 2.0',
                url: 'https://github.com/kalyxi/kalyxi-flow/blob/main/LICENSE.md'
            },
            contact: {
                name: 'Kalyxi',
                email: 'support@kalyxi.ai'
            }
        },
        servers: [
            {
                url: 'http://localhost:3000/api/v1',
                description: 'Kalyxi Flow Server'
            }
        ]
    },
